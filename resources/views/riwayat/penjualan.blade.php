        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Data Riwayat Penjualan</h5>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($penjualans as $penjualan)
                                <tr>
                                    ...
                                    <td>{{ $penjualan->tanggal_nota }}</td>
                                    <td>{{ $penjualan->supplier->nama_supplier }}</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="detailModal{{ $penjualan->id }}" tabindex="-1"
                                            aria-labelledby="detailModalLabel{{ $penjualan->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p><strong>Nota:</strong> {{ $penjualan->nota }}</p>
                                                        <p><strong>Tanggal Penjualan:</strong>
                                                            {{ $penjualan->tanggal_penjualan }}</p>
                                                        <p><strong>Nama Supplier:</strong>
                                                            {{ $penjualan->supplier->nama_supplier }}</p>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                @foreach ($details->where('nota', $penjualan->nota) as $detail)
                                                                    <tr>
