            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-1">Nota: <strong>PB001</strong></h6>
                            <h6 class="mb-0">Tanggal: <strong>24/04/2025</strong></h6>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <select class="form-select" id="supplierSelect" name="supplier_id" style="width: 200px;">
                                <option selected disabled>Pilih Supplier</option>
                                <option value="1">PT Kimia Farma</option>
                                <option value="2">PT Indofarma</option>
                                <option value="3">PT Dexa Medica</option>
