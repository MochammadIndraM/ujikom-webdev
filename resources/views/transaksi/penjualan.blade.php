...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 d-flex justify-content-end">
                        <div class="card p-3" style="width: 300px;">
                            <form action="{{ route('penjualan.simpan') }}" method="POST" id="formPenjualan">
                                @csrf
                                <!-- Diskon Input -->
    ...
    <div class="modal fade" id="modalJualObat" tabindex="-1" aria-labelledby="modalJualObatLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalJualObatLabel">Pilih Obat</h5>
    ...
    <script>
        document.getElementById('supplierSelect').addEventListener('change', function() {
            ...
            fetch(`/get-obat-by-supplier/${supplierId}`)
                ...
                .then(data => {
                    const tableBody = document.querySelector('#modalJualObat tbody');
                    ...
                    data.forEach(obat => {
                        ...
                        row.dataset.hargaJual = obat
                            .harga_jual; // Tambahkan harga_jual sebagai atribut data
                        row.innerHTML = `
                        <td>${obat.nama_obat}</td>
                        <td>${parseInt(obat.harga_jual).toLocaleString()}</td>
                        <td>
    ...
    <script>
        ...
        document.querySelector('#modalJualObat form').addEventListener('submit', function(e) {
            e.preventDefault(); // Mencegah form reload

            const tableBody = document.querySelector('#table1 tbody');
            const modalTableBody = document.querySelector('#modalJualObat tbody'); // Update to correct modal
            ...
            modalTableBody.querySelectorAll('tr').forEach(row => {
                ...
                const harga = row.dataset.hargaJual; // Ambil harga dari data attribute
            ...
            // Tutup modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalJualObat'));
            modal.hide();
